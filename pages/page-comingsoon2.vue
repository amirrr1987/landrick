<template>
  ...
  >
    <div
      class="container position-relative text-md-start text-center"
      style="z-index: 1"
    >
      <div class="row">
        <div class="col-md-12">
          ...
          >
            <span
              class="text-white typewrite"
              data-period="2000"
              data-type='[ "ما به زودی می آییم...", "ما آماده ایم تا", "با ما در ارتباط هستیم" ]'
            >
              <span class="wrap"></span>
            </span>
          </h1>
          <p class="text-light para-dark para-desc">
            شروع به کار با <span class="fw-bold"> لنـدریـک </span> که می تواند
            هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز
            دارید فراهم کند.
          </p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <a
            ...
            ><i class="mdi mdi-check"></i> به من اطلاع دهید
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content rounded shadow border-0">
        ...
        <div class="modal-body">
          <div class="bg-white p-3 rounded box-shadow">
            <p>
              به زودی می آییم لطفاً ، شناسه نامه خود را وارد کنید و مشترک شوید.
            </p>
