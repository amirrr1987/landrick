                ...
                <div class="col-lg-7 col-md-7 text-center">
                    ...
                    <div class="title-heading mt-0 mt-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        ...
                        <div class="mt-4 pt-2">
                            ...
                            <a href="page-contact-one.html" class="btn btn-outline-primary mt-2"><i
                                    class="mdi mdi-phone"></i> تماس با ما</a>
                        </div>
                    </div>
                </div>
            </div><!--end row-->
            ...
            <div class="col-12 text-center">
                <div class="section-title">
                    ...
                    <p class="text-muted para-desc mx-auto">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک
                        ...
                        فراهم کند.</p>
                    <div class="mt-4 pt-2">
                        <a href="https://www.rtl-theme.com/?p=133270" target="_blank" class="btn btn-primary m-1">اکنون
