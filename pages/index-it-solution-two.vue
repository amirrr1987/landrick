<template>
  <!-- Hero Start -->
  <section
    class="bg-half-170 d-table w-100 it-home"
    style="background: url('images/it/bg1.jpg') center center"
  >
      ...
      <div class="row align-items-center">
        <div class="col-lg-7 col-md-6 col-12">
          <div class="title-heading">
            ...
            <h1 class="fw-bold text-white title-dark mt-2 mb-3">
              نوآورانه پیشرفته <br />
              راه حل های اطلاعات.
            </h1>
            ...
            <div class="mt-4 pt-2">
              <a href="javascript:void(0)" class="btn btn-primary m-1"
                ><i class="uil uil-phone"></i> در تماس باشید</a
              >
              <a
                href="#!"
                data-type="youtube"
              ...
              ><small
                class="fw-bold text-uppercase text-light title-dark align-middle ms-1"
                >اکنون تماشا کنید</small
              >
            </div>
          </div>
        </div>
              ...
              <form class="login-form">
                <div class="row">
                  <div class="col-md-12">
                    <div class="mb-3">
                      <label class="form-label"
                        >نام اصلی <span class="text-danger">*</span></label
                      >
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      <label class="form-label"
                        >شماره تلفن <span class="text-danger">*</span></label
                      >
                      <div class="form-icon position-relative">
                    ...
                    <div class="form-check mb-3">
                      ...
                      <label class="form-check-label" for="flexCheckDefault">
                        ...
                        <a href="#" class="text-primary"
                          >قوانین سایت لنـدریـک را و تیکت را فعال میکنم</a
                        >
                      </label>
                    </div>
                  </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-3 col-md-6 col-12">
          <div class="d-flex features pt-4 pb-4">
            <div
              class="icon text-center rounded-circle text-primary me-3 h5 mb-0"
            >
            ...
            <div class="flex-1">
              ...
              <p class="text-muted para mb-0">
                ساخته شده به زبان شبه لاتین که.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="d-flex mt-4 pt-2">
              ...
              <div class="flex-1 ms-2">
                ...
                <p class="mb-0 text-muted">
                  هنگامی که متن ساختگی نسبتاً واقع بینانه باشد ، به گونه ای
                  سودمند خواهد بود که طرح بندی ایجاد شود
                </p>
              </div>
            </div>
    ...
    <div class="container mt-100 mt-60">
      <div class="row justify-content-center">
        <div class="col-12 text-center">
          <div class="section-title mb-4 pb-2">
            <h4 class="title mb-4">
              ما راه حل های فناوری اطلاعات و تجارت ارائه می دهیم
            </h4>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 mt-4 pt-2">
          <div
            class="d-flex key-feature align-items-center p-3 rounded-pill shadow"
          >
        ...
        <div class="col-12 mt-4 pt-2 text-center">
          <a href="javascript:void(0)" class="btn btn-primary"
            >نمایش بیشتر <i class="uil uil-angle-left"></i
          ></a>
        </div>
        <!--end col-->
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-12">
          <div class="video-solution-cta position-relative" style="z-index: 1">
            <div
              class="position-relative py-5 rounded"
              style="background: url('images/it/cta.jpg') top"
            >
              <div
                class="bg-overlay rounded bg-primary bg-gradient"
                style="opacity: 0.8"
              ></div>
              ...
              <div class="row">
                <div class="col-lg-3 col-6 my-4">
                  <div class="counter-box text-center px-lg-4">
                    ...
                    <h1 class="mb-0 text-white">
                      <span class="counter-value" data-target="9759">100</span>+
                    </h1>
                ...
                <div class="col-lg-3 col-6 my-4">
                  <div class="counter-box text-center px-lg-4">
                    ...
                    <h1 class="mb-0 text-white">
                      <span class="counter-value" data-target="151">12</span>+
                    </h1>
                      ...
                      <div class="d-flex client-testi m-2">
                        ...
                        >
                          ...
                          <p class="text-muted mt-2">
                            " به نظر می رسد که تنها تکه هایی از متن اصلی در متن
                            لورم اپیسوم که امروزه استفاده می شود باقی مانده است.
                            "
                          </p>
