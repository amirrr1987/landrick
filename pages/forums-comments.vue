      ...
      <div class="row justify-content-center">
        <div class="col-lg-12 text-center">
          <div class="page-next-level">
            <h4 class="title">نظرات نویسنده</h4>
            <div class="page-next">
              <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-white rounded shadow mb-0">
                  ...
                  <li class="breadcrumb-item">
                    <a href="forums.html">انجمن ها</a>
                  </li>
                  <li class="breadcrumb-item">
                    <a href="forums-topic.html">تاپیک انجمن ها</a>
                  </li>
            ...
            <div class="p-4">
              ...
              <div class="mt-3">
                <p class="text-muted mb-0">
                  ...
                  توسط طراحی وب برای اشغال فضا است که بعداً با محتوای "واقعی" پر
                  خواهد شد. این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در
                  دسترس نیست."
                </p>
              </div>
            </div>
                ...
                <form class="login-form mt-4">
                  <div class="row">
                    ...
                    <div class="col-12 text-center">
                      <p class="mb-0 mt-4">
                        <small class="text-dark me-2">حسابی ندارید؟ </small>
                        <a
