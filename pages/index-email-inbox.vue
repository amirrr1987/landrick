            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        ...
                        <div class="mt-4 pt-2">
                            <a href="#about" class="btn btn-primary">آزمایش رایگان را شروع کنید <i
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="home-dashboard">
                                <img src="~/assets/images/email/home.png" alt="" class="img-fluid rounded-md shadow-lg"
                                    style="z-index: 0;">
                            </div>
                        </div>
                    </div><!--end row-->
                ...
                <div class="col-lg-4 col-md-6 mt-5">
                    <div class="d-flex features feature-clean">
                        ...
                        <div class="flex-1 content ms-4">
                            ...
                            <p class="text-muted mb-0">مشهورترین متن ساختگی متن است که گفته می شود از قرن شانزدهم شروع شده
                                است.</p>
                        </div>
                    </div>
                </div><!--end col-->
            ...
            <div class="row align-items-end mb-4 pb-2">
                ...
                <div class="col-md-4 mt-4 mt-sm-0">
                    <div class="text-center text-md-end">
                        <ul class="nav nav-pills bg-white rounded-lg justify-content-center d-inline-block shadow py-1 px-2 mb-0"
                            id="pills-tab" role="tablist">
                            <li class="nav-item d-inline-block">
                                <a class="nav-link px-3 rounded-lg active monthly" id="Monthly" data-bs-toggle="pill"
                                    href="#Month" role="tab" aria-controls="Month" aria-selected="true">ماهانه </a>
                            </li>
                            <li class="nav-item d-inline-block">
                                <a class="nav-link px-3 rounded-lg yearly" id="Yearly" data-bs-toggle="pill" href="#Year"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-unstyled mb-0 ps-0">
                                                ...
                                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                    ...
                                                    منبع </li>
                                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                            class="uil uil-check-circle align-middle"></i></span>1 دامنه
                                                    رایگان </li>
                                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-unstyled mb-0 ps-0">
                                                ...
                                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                    ...
                                                    رایگان </li>
                                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                            class="uil uil-check-circle align-middle"></i></span>اقساط
                                                    رایگان</li>
                                            </ul>
