<template>
                ...
                <div class="col-lg-6 col-md-7">
                    <div class="title-heading mt-4">
                        <div class="alert alert-white alert-pills shadow" role="alert">
                            ...
                            <span class="content"> ساخته شده برای <span class="text-primary">همه ی مشاغل </span> شما به
                                لنـدریــک نیاز دارید..</span>
                        </div>
                        <h1 class="heading mb-3">پیشرو در تجارت دیجیتال برای <span class="text-primary typewrite"
                                data-period="2000" data-type='[ "آژانسی", "نرم افزار", "تکنولوژی", "استدیو", "اپ وب" ]'>
                                <span class="wrap"></span> </span> با بهترین امکانات </h1>
                        ...
                        <div class="mt-4">
                            <a href="javascript:void(0)" class="btn btn-outline-primary rounded"><i
                                    class="uil uil-store"></i> فروشگاه خود را بسازید </a>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-md-4 col-12 mt-5">
                    <div class="features">
                        ...
                        <div class="content mt-4">
                            ...
                            <p class="text-muted mb-0">گفته می شود ، یک محقق لاتین با تأسیس واژه غیرمعمول ، اصل متن را تأسیس
                                کرد.</p>
                        </div>
                    </div>
                </div><!--end col-->
    ...
    <!-- CTA Start -->
    <section class="section bg-cta" data-jarallax='{"speed": 0.5}' :style="`background: url(${bgImg});`" id="cta">
                ...
                <div class="col-lg-6">
                    <div class="section-title">
                        <h4 class="title mb-4">همه چیز را در مورد خود ببینید <span class="text-primary"> لنـدریـک </span>
                            کسب و کار شماست </h4>
                        <p class="text-muted para-desc">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک </span>
