            ...
            <div class="row align-items-center mt-5 mt-sm-0">
                <div class="col-md-6">
                    <div class="title-heading text-center text-md-start">
                        ...
                        <h4 class="heading mb-3 mt-2">مستقل خود را رشد دهید <span class="fw-bold"> کسب و کار برای شماست
                            </span></h4>
                        <p class="text-muted mb-0 para-dark para-desc mx-auto ms-md-auto">کمپین خود را راه اندازی کنید و از
                            تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-12 order-1 order-lg-2">
                    <div class="section-title text-center text-lg-start mb-4 mb-lg-0 pb-2 pb-lg-0">
                        ...
                        <p class="text-muted para-desc mx-auto ms-lg-auto mb-0">شروع به کار با <span
                            ...
                            <div class="row">
                                <div class="col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                    <div
                                        ...
                                        <div class="card-body p-0 mt-4">
                                            <a href="javascript:void(0)" class="title h5 text-dark">هدفمند <br> با سرنخ های
                                                با کیفیت بالا </a>
                                            <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده
                                                در طرح آن.</p>
                                ...
                                <div class="col-12 mt-4 pt-2">
                                    <div
                                        ...
                                        <div class="card-body p-0 mt-4">
                                            <a href="javascript:void(0)" class="title h5 text-dark">ارسال ، برنامه ریزی و
                                                تعویق ایمیل ها</a>
                                            <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده
                                                در طرح آن.</p>
                            ...
                            <div class="row pt-lg-4 mt-lg-4">
                                <div class="col-12 mt-4 pt-2">
                                    <div
                                        ...
                                        <div class="card-body p-0 mt-4">
                                            <a href="javascript:void(0)" class="title h5 text-dark">کتابخانه بهترین الگوهای
                                                ایمیل</a>
                                            <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده
                                                در طرح آن.</p>
                                ...
                                <div class="col-12 mt-4 pt-2">
                                    <div
                                        ...
                                        <div class="card-body p-0 mt-4">
                                            <a href="javascript:void(0)" class="title h5 text-dark">یادآوری های پیگیری
                                                خودکار</a>
                                            <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده
                                                در طرح آن.</p>
                ...
                <div class="col-md-4 mt-4 pt-2">
                    <ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-0 sticky-bar"
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link rounded" id="contract" data-bs-toggle="pill" href="#data-analise" role="tab"
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link rounded" id="crm" data-bs-toggle="pill" href="#security" role="tab"
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link rounded" id="invoice" data-bs-toggle="pill" href="#invoices" role="tab"
                ...
                <div class="col-md-8 col-12 mt-4 pt-2">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade bg-white show active p-4 rounded shadow" id="developing" role="tabpanel"
                            ...
                            <p class="text-muted mb-0">این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن
                                ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن
                                ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز
                                خواندن با ملودی.</p>

                            <div class="mt-4">
                                <a href="javascript:void(0)" class="text-primary h6">پیشنهادها را کاوش کنید <i
                        ...
                        <div class="tab-pane fade bg-white p-4 rounded shadow" id="data-analise" role="tabpanel"
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="text-primary h6">قراردادها را کاوش کنید <i
                                        class="uil uil-angle-left-b align-middle"></i></a>
                            </div>
                        ...
                        <div class="tab-pane fade bg-white p-4 rounded shadow" id="security" role="tabpanel"
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="text-primary h6">پروژه ها را کاوش کنید <i
                                        class="uil uil-angle-left-b align-middle"></i></a>
                            </div>
                        ...
                        <div class="tab-pane fade bg-white p-4 rounded shadow" id="time-track" role="tabpanel"
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="text-primary h6">ردیابی زمان را کاوش کنید <i
                                        class="uil uil-angle-left-b align-middle"></i></a>
                            </div>
                        ...
                        <div class="tab-pane fade bg-white p-4 rounded shadow" id="invoices" role="tabpanel"
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="text-primary h6">فاکتور را کاوش کنید <i
                                        class="uil uil-angle-left-b align-middle"></i></a>
                            </div>
                        ...
                        <div class="tab-pane fade bg-white p-4 rounded shadow" id="task-track" role="tabpanel"
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="text-primary h6">پیگیری وظیفه را کاوش کنید <i
                                        class="uil uil-angle-left-b align-middle"></i></a>
                            </div>
                    ...
                    <div class="d-inline-block">
                        <div class="pt-4 d-flex align-items-center border-top">
                            ...
                            <div class="content">
                                ...
                                <a href="javascript:void(0)" class="text-primary h6">ادامه مطلب <i
                                        class="uil uil-angle-left-b"></i></a>
                            </div>
                        </div>
                    </div>
