            ...
            <div class="row align-items-center mt-md-5">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check mb-3">
                                            ...
                                            <label class="form-check-label" for="flexCheckDefault">
                                                تایید میکنم <a href="#" class="text-primary">قوانین سایت لنـدریـک را و تیکت
                                                    را فعال میکنم</a>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 mt-4 text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mt-3">
                                                <div class="d-grid">
                                                    <a href="javascript:void(0)" class="btn btn-light"><i
                                                            class="uil uil-facebook text-primary"></i> فیس بوک </a>
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-lg-6 mt-3">
                                                <div class="d-grid">
                                                    <a href="javascript:void(0)" class="btn btn-light"><i
                                                            class="uil uil-google text-danger"></i> گوگل </a>
                                                </div>
                                            </div><!--end col-->
                                        </div>
                                    </div>
                ...
                <div class="col-lg-7 col-md-6 order-1 order-md-2">
                    <div class="title-heading mt-4 ms-lg-4">
                        ...
                        <p class="para-desc para-dark text-light">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و
                            مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                        <div class="mt-4 pt-2">
                            <a href="javascript:void(0)" class="btn btn-primary m-1">شروع کنید <i
                                    class="uil uil-angle-left-b"></i></a>
                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                                class="btn btn-icon btn-pills btn-primary m-1 lightbox"><i data-feather="video"
                                    class="icons"></i></a><small
                                class="fw-bold text-uppercase text-light title-dark align-middle ms-1">اکنون تماشا
                                کنید</small>
                        </div>
                    </div>
                </div><!--end col-->
    ...
    <section class="section">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-7 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="section-title ms-lg-4">
                        ...
                        <p class="text-muted">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند
                            هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
        ...
        <div class="container mt-100 mt-60">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <h4 class="title mb-4">همه چیز را در مورد خود ببینید <span class="text-primary">لنـدریـک </span>
                        </h4>
            ...
            <div class="row" id="counter">
                ...
                <div class="col-md-3 col-6 mt-4 pt-2">
                    <div class="counter-box text-center">
                        <img src="~/assets/images/illustrator/Asset186.svg" class="avatar avatar-small" alt="">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 ps-0">
                                ...
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>فایل های منبع </li>
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>قرار ملاقات رایگان</li>
                            </ul>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 ps-0">
                                ...
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>1 دامنه رایگان </li>
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>اقساط رایگان</li>
                            </ul>
        ...
        <div class="container mt-100 mt-60">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 mt-4 pt-2 text-center">
                    <div class="tiny-single-item">
                        <div class="tiny-slide client-testi text-center">
                            <p class="text-muted h6 fst-italic">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم
                                اپیسوم که امروزه استفاده می شود باقی مانده است. به نظر می رسد که تنها تکه هایی از متن اصلی
                                در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                        ...
                        <div class="tiny-slide client-testi text-center">
                            <p class="text-muted h6 fst-italic">" مزیت ریشه لاتین آن و بی معنی بودن نسبی لورم ایپسوم این است
                                که متن توجه را به خود جلب نمی کند یا توجه بیننده را از طرح منحرف نمی کند.. "</p>
                        ...
                        <div class="tiny-slide client-testi text-center">
                            <p class="text-muted h6 fst-italic">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم
                                اپیسوم که امروزه استفاده می شود باقی مانده است صرفاً برای پر کردن یک فضا. این گزینه ها برای
                                متن های کلاسیک لورم اپیسوم اغلب سرگرم کننده هستند و داستان های کوتاه ، خنده دار یا مزخرفی را
                                روایت می کنند. "</p>
                    ...
                    <div class="tiny-slide client-testi text-center">
                        <p class="text-muted h6 fst-italic">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم
                            اپیسوم که امروزه استفاده می شود باقی مانده است در سال 45 قبل از میلاد. گفته می شود ، یک محقق
                            لاتین با جمع آوری تمام موارد کلمه غیرمعمول "لورم اپیسوم" که می توانست پیدا کند ، اصل متن را
                            تأسیس کرد "</p>
                    ...
                    <div class="tiny-slide client-testi text-center">
                        <p class="text-muted h6 fst-italic">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم
                            اپیسوم که امروزه استفاده می شود باقی مانده است. می توان حدس زد که در طول زمان حروف خاصی به
                            موقعیتهای مختلف متن اضافه یا حذف شده اند. "</p>
