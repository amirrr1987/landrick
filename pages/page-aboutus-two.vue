<template>
        ...
        <div class="col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
          <div class="ms-lg-4">
            <div class="d-flex mb-4">
              ...
              <span class="h6 align-self-end ms-2">سال <br />
                تجربه
              </span>
            </div>
            <div class="section-title">
              ...
              <p class="text-muted">
                ...
                اتصال به آن نیاز دارید فراهم کند. متن ساختگی متنی است که در
                صنعت نشر یا طراحان وب برای اشغال فضایی استفاده می شود که بعداً
                با محتوای واقعی پر خواهد شد. این مورد زمانی الزامی است که
                مثلاً متن نهایی هنوز در دسترس نیست. متون ساختگی از قرن شانزدهم
                مورد استفاده حروفچینی ها قرار گرفته اند.
              </p>
              <a href="javascript:void(0)" class="btn btn-primary mt-3">تماس با ما</a>
            </div>
          </div>
        </div>
        <!--end col-->
  ...
  <section class="section bg-light">
          ...
          <div class="card features feature-clean work-process bg-transparent process-arrow border-0 text-center">
            ...
            <div class="card-body">
              ...
              <p class="text-muted mb-0">
                مشهورترین متن ساختگی "لورم اپیسوم" است که گفته می شود ریشه
                دارد
              </p>
            </div>
          </div>
    ...
    <div class="container mt-100 mt-60">
      ...
      <div class="row">
        <div class="col-md-4 mt-4 pt-2">
          <ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-0 sticky-bar" id="pills-tab"
            role="tablist">
            <li class="nav-item">
              <a class="nav-link rounded active" id="webdeveloping" data-bs-toggle="pill" href="#developing" role="tab"
                aria-controls="developing" aria-selected="false">
                <div class="text-center py-1">
                  <h6 class="mb-0">توسعه وب</h6>
                </div>
              </a><!--end nav link-->
            </li>
            <!--end nav item-->
            ...
            <li class="nav-item mt-2">
              <a class="nav-link rounded" id="database" data-bs-toggle="pill" href="#data-analise" role="tab"
                ...
                <div class="text-center py-1">
                  <h6 class="mb-0">تحلیل پایگاه داده</h6>
                </div>
              </a><!--end nav link-->
            </li>
            <!--end nav item-->
            ...
            <div class="tab-pane fade bg-white show active p-4 rounded shadow" id="developing" role="tabpanel"
              ...
              <div class="mt-4">
                <p class="text-muted">
                  ...
                  نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته
                  می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان
                  شعر استفاده می کردند.
                </p>
                <a href="javascript:void(0)" class="text-primary">نمایش بیشتر
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-12 mt-4 pt-md-2">
                      <div class="section-title text-md-start">
                        ...
                        <a href="javascript:void(0)" class="text-white title-dark">ادامه مطلب
                          <i class="uil uil-angle-left-b align-middle"></i></a>
                      </div>
                    </div>
                  </div>
