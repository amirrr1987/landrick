        ...
        <div class="col-lg-6 col-md-7">
          <div class="title-heading">
            <h1 class="heading mb-3">
              با استفاده از همه موارد خود را مدیریت کنید
              <span class="text-primary">لنـدریــک .</span> اپ سایت در دسترس است
            </h1>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 col-md-6 mt-4 pt-2">
          <div class="section-title ms-lg-5">
            <h4 class="title mb-4">
              بهترین <span class="text-primary">لنـدریـک </span> با همکاری خوب
              برای شما
            </h4>
            <p class="text-muted">
    ...
    <div class="container mt-100 mt-60">
      <div class="row justify-content-center">
        <div class="col-12 text-center">
          <div class="section-title mb-4 pb-2">
            <h4 class="title mb-4">
              <span class="text-primary">لنـدریـک </span> ویترین برنامه
            </h4>
            <p class="text-muted para-desc mb-0 mx-auto">
              شروع به کار با
              <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                  <div class="section-title">
                    <h4 class="title mb-4">
                      <i class="uil uil-angle-double-right text-primary"></i>
                      برنامه فرود با عملکرد بالا
                    </h4>
                    <p class="text-muted">
                      شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد
                      ترکیب کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و
                      از آن در وب سایت استفاده کنید.
                    </p>
                    <ul class="list-unstyled text-muted">
                      <li class="mb-0">
                        <span class="text-primary h5 me-2"
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-4 col-12 mt-4 pt-2">
          <div
            class="card pricing-rates starter-plan bg-light py-5 border-0 rounded text-center"
          >
            <div class="card-body">
              <h6 class="title fw-bold text-uppercase text-primary mb-4">
                برای شروع
