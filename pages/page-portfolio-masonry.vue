  ...
  <section class="section">
    <div class="container">
      ...
      <div id="grid" class="row">
        <div
          class="col-lg-3 col-md-6 col-12 spacing picture-item"
        ...
        >
          ...
          >
            <div class="card-body p-0">
              ...
              <div class="content">
                <h5 class="mb-0">
                  <a href="page-portfolio-detail.html" class="text-white title"
                    >مجموعه ماکت</a
                  >
                </h5>
