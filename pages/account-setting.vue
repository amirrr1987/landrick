        ...
        <div class="col-lg-8 col-12">
          ...
          <div class="rounded shadow mt-4">
            <div class="p-4 border-bottom">
              <h5 class="mb-0">اعلان های حساب :</h5>
            </div>

            <div class="p-4">
              <div class="d-flex justify-content-between pb-4">
                <h6 class="mb-0">وقتی کسی از من نام می برد</h6>
              ...
              <div class="d-flex justify-content-between py-4 border-top">
                <h6 class="mb-0">وقتی کسی مرا تعقیب می کند</h6>
                <div class="form-check">
                  <input
                    class="form-check-input"
                    type="checkbox"
              ...
              <div class="d-flex justify-content-between py-4 border-top">
                <h6 class="mb-0">هنگامی که فعالیت من را به اشتراک می گذارد</h6>
                <div class="form-check">
                  <input
                    class="form-check-input"
                    type="checkbox"
              ...
              <div class="d-flex justify-content-between py-4 border-top">
                <h6 class="mb-0">وقتی کسی به من پیام می دهد</h6>
                <div class="form-check">
                  <input
                    class="form-check-input"
                    type="checkbox"
          ...
          <div class="rounded shadow mt-4">
            <div class="p-4 border-bottom">
              <h5 class="mb-0">اعلان های بازاریابی :</h5>
            </div>

            <div class="p-4">
              <div class="d-flex justify-content-between pb-4">
                <h6 class="mb-0">یک فروش یا تبلیغ وجود دارد</h6>
                <div class="form-check">
                  <input
                    class="form-check-input"
                    type="checkbox"
              ...
              <div class="d-flex justify-content-between py-4 border-top">
                <h6 class="mb-0">اخبار را لغو اشتراک کنید</h6>
                <div class="form-check">
                  <input
                    class="form-check-input"
                    type="checkbox"
