            ...
            <div class="card-body">
              ...
              <form class="login-form mt-4">
                <div class="row">
                  ...
                  <div class="col-lg-12 mt-4 text-center">
                    ...
                    <div class="row">
                      <div class="col-6 mt-3">
                        <div class="d-grid">
                          <a href="javascript:void(0)" class="btn btn-light"
                            ><i class="mdi mdi-facebook text-primary"></i> فیس
                            بوک
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="col-6 mt-3">
                        <div class="d-grid">
                          <a href="javascript:void(0)" class="btn btn-light"
                            ><i class="mdi mdi-google text-danger"></i> گوگل
                          </a>
                        </div>
                      </div>
                      <!--end col-->
                  ...
                  <div class="mx-auto">
                    <p class="mb-0 mt-3">
                      <small class="text-dark me-2">قبلاً حساب دارید؟</small>
                      <a href="auth-login-three.html" class="text-dark fw-bold"
                        >وارد شوید
                      </a>
                    </p>
                  </div>
