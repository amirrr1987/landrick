            ...
            <div class="row align-items-center pt-5">
                <div class="col-lg-7 col-md-6">
                    <div class="title-heading">
                        ...
                        <div class="mt-4 pt-2">
                            <a href="https://www.rtl-theme.com/?p=133270" target="_blank" class="btn btn-primary">اکنون
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="saas-feature-shape-left position-relative">
                        <img src="~/assets/images/saas/classic02.png" class="img-fluid mx-auto d-block rounded shadow"
                            alt="">
                    </div>
                </div><!--end col-->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex align-items-center pt-4">
                                    ...
                                    <div class="ms-3">
                                        <h5>کاملاً امن </h5>
                                        <p class="text-muted mb-0">علاوه بر این ، در لاتین فقط کلمات در ابتدای جملات با حروف
                                            بزرگ هستند.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-12 pt-4">
                                <a href="javascript:void(0)" class="btn btn-outline-primary">اکنون نصب کن <i
            ...
            <div class="row justify-content-center" id="counter">
                <div class="col-12 text-center">
                    <div class="section-title">
                        <h4 class="title mb-4">به طور کلی <span class="text-primary"><span class="counter-value"
                                    data-target="333">1</span>هزار +</span> مشتری در حال استفاده است ، شروع کنید</h4>
                        <p class="text-muted para-desc mx-auto mb-0">با محبوب ترین کتابخانه مهای جلویی جهان ، پروژه های
                            پاسخگو و همراه اول را در وب ایجاد کنید.</p>
