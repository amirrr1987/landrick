            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        <h1 class="heading mb-4">یک راه حل برای شما <span class="text-primary"> بازاریابی از طریق رسانه های
                                اجتماعی </span></h1>
                        ...
                        <ul class="mt-4 list-unstyled mb-0 align-items-center">
                            <li class="list-inline-item"><a href="page-contact-one.html" class="btn btn-primary me-2"><i
                                        class="uil uil-envelope"></i> درخواست دمو</a></li>
                            <li class="list-inline-item text-muted me-2 h6">یا </li>
                            <li class="list-inline-item"><a href="javascript:void(0)" class="text-primary fw-bold"> رایگان
                                    امتحان کنید <i class="uil uil-angle-left-b align-middle"></i></a></li>
                        </ul>
                    </div>
            ...
            <div class="row justify-content-center" id="counter">
                <div class="col-lg-8 col-md-10">
                    <div class="mb-4 pb-2 text-center">
                        <h5 class="mb-0 fw-normal text-muted">وارد شوید <span class="text-success fw-bold"><span
                                    class="counter-value" data-target="555">1</span>+</span> با عنوان کاربر <span
                                class="fw-bold text-primary">لنـدریــک .</span> برای جلب مشارکت مشتری ، ایجاد وفاداری به
                            برند و رشد تجارت آنها</h5>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
                ...
                <div class="col-lg-6 col-md-8 pb-md-4">
                    <ul class="text-center mb-0 p-0">
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-blue" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="فیسبوک"><i data-feather="facebook" class="icons"></i></a>
                        </li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-danger" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="اینستاگرام"><i data-feather="instagram"
                                    class="icons"></i></a></li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-secondary" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="لینکدین"><i data-feather="linkedin" class="icons"></i></a>
                        </li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-info" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="توییتر"><i data-feather="twitter" class="icons"></i></a></li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-warning" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="Gitlab"><i data-feather="gitlab" class="icons"></i></a></li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-danger" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="یوتیوب"><i data-feather="youtube" class="icons"></i></a></li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-success" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="Whatsapp"><i class="mdi mdi-whatsapp icons"></i></a></li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-info" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="تلگرام"><i class="mdi mdi-telegram icons"></i></a></li>
                        <li class="list-inline-item mx-2 mt-3"><a href="javascript:void(0)"
                                class="btn btn-icon btn-pills btn-lg btn-blue" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="اسکایپ"><i class="mdi mdi-skype icons"></i></a></li>
                    </ul>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6 col-12 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="section-title ms-lg-4">
                        ...
                        <h4 class="title mb-3">تمام <br> <span class="text-primary">اکانت های مجازی را </span> مدیریت کنید
                        </h4>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6 col-12 order-2 order-md-1 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="section-title me-lg-4">
                        ...
                        <h4 class="title mb-3">سریع رشد کن <br> <span class="text-primary">تا موفق تر شی</span></h4>
                        <p class="text-muted">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد آگاهی ،
                        ...
                        <ul class="list-unstyled text-muted">
                            <li class="mb-0"><span class="text-primary h5 me-2"><i
                                ...
                                برای فردا</li>
                            <li class="mb-0"><span class="text-primary h5 me-2"><i
                                        class="uil uil-check-circle align-middle"></i></span>با استعداد ما و آژانس بازاریابی
                                مجرب</li>
                            <li class="mb-0"><span class="text-primary h5 me-2"><i
            ...
            <div class="row align-items-center">
                                ...
                                <div class="col-12 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-3 title">رسانه های اجتماعی را مدیریت کنید</h5>
                                            <p class="text-muted mb-0">متن ساختگی متنی است که در انتشارات استفاده می شود</p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                ...
                                <div class="col-12 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-3 title">بدون رابط</h5>
                                            <p class="text-muted mb-0">متن ساختگی متنی است که در انتشارات استفاده می شود</p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                ...
                                <div class="col-12 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-3 title">نصب رایگان</h5>
                                            <p class="text-muted mb-0">متن ساختگی متنی است که در انتشارات استفاده می شود</p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                ...
                <div class="col-lg-6 col--6 col-12 mt-4 pt-2 mt-lg-0 pt-lg-0">
                    <div class="section-title ms-lg-4">
                        ...
                        <h4 class="title mb-3">ویژگی های عالی ما</h4>
                        <p class="text-muted">به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح بندی, غیرقابل
                            خواندن از اهمیت زیادی برخوردار است: ادراک انسان برای شناسایی الگوها و تکرارهای خاص در متن تنظیم
                            شده است. اگر توزیع حروف تأثیر بصری داشته باشد.</p>
                        <div class="mt-4">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6 col-12 order-2 order-md-1 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="section-title me-lg-4">
                        ...
                        <h4 class="title mb-3">ما شما را ادغام کردیم <br> علاقه داریم به <span class="text-primary">شبکه
                                سوشیال</span></h4>
                        <p class="text-muted">به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح بندی, غیرقابل
                            خواندن از اهمیت زیادی برخوردار است: ادراک انسان برای شناسایی الگوها و تکرارهای خاص در متن تنظیم
                            شده است. اگر توزیع حروف تأثیر بصری داشته باشد.</p>
                        <div class="d-inline-block">
                            <div class="pt-3 d-flex align-items-center border-top">
                                ...
                                <div class="content">
                                    <h6 class="mb-0">باهوش تر شوید</h6>
                                    <a href="javascript:void(0)" class="text-primary">مطالب بیشتر راه حل <i
            ...
            <div class="row pt-md-5 justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        <h4 class="title mb-4">داستان های کاربران</h4>
                ...
                <div class="row align-items-end">
                    <div class="col-md-8">
                        <div class="section-title text-md-start text-center">
                            ...
                            <p class="text-white-50 mb-0">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای
...
<!-- Social Icons , features and testi End --></template>
