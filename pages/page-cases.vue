        ...
        <div class="col-12 filters-group-wrap">
          <div class="filters-group">
            <ul class="container-filter list-inline mb-0 filter-options text-center">
              ...
              <li class="list-inline-item categories-name border text-dark rounded" data-group="business">
                شرکتی
              </li>
              <li class="list-inline-item categories-name border text-dark rounded" data-group="marketing">
                مارکتینگ
              </li>
              <li class="list-inline-item categories-name border text-dark rounded" data-group="finance">
                مالی
              </li>
              <li class="list-inline-item categories-name border text-dark rounded" data-group="human">
                تحقیقات انسانی
              </li>
            </ul>
          </div>
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                ...
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">200% دسترسی گسترده به فیس بوک</a>
                </h5>
                <p class="text-muted">
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                ...
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">موفقیت در جستجوگرها برای عایق بندی</a>
                </h5>
                <p class="text-muted">
                  این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس
                  نیست.
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                ...
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">مبارزات دوستانه برای موبایل</a>
                </h5>
                <p class="text-muted">
                  این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس
                  نیست.
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                ...
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">کمپین HVAC سئو</a>
                </h5>
                <p class="text-muted">
                  این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس
                  نیست.
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                ...
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">شبکه سوشیال و کسب و کار کوچک
                  </a>
                </h5>
                <p class="text-muted">
                  این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                <a href="javascript:void(0)" class="badge badge-link bg-warning">بازاریابی</a>
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">موفقیت PPC برای شرکت HVAC</a>
                </h5>
                <p class="text-muted">
                  این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس
                  نیست.
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                ...
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">مطالعات موردی تجارت الکترونیکی PPC</a>
                </h5>
                <p class="text-muted">
                  این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس
                  نیست.
          ...
          <div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
            ...
            <div class="card-body">
              <div class="content">
                <a href="javascript:void(0)" class="badge badge-link bg-info">HR</a>
                <h5 class="mt-3">
                  <a href="page-case-detail.html" class="text-dark title">ماکت آیفون</a>
                </h5>
                <p class="text-muted">
                  این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس
                  نیست.
