            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="3000">
                    <div class="bg-home d-flex align-items-center"
                        style="background: url('images/coworking/bg01.jpg') center center;">
                        <div class="bg-overlay"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-12 text-center">
                                    <div class="title-heading mt-4">
                                        <h6 class="text-light para-dark animated fadeInDownBig animation-delay-1">دفاتر شخصی
                                            و فضای کار مشترک برای <span class="text-success">98000 تومان</span></h6>
                                        <h1
                                            class="heading mb-3 text-white title-dark animated fadeInUpBig animation-delay-3">
                                            فضای همکاری برای موفقیت</h1>
                                        <p
                                            class="para-desc text-light para-dark mx-auto animated fadeInUpBig animation-delay-7">
                                            کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ
                                            v5 html تبدیل محور بهره مند شوید.</p>
                                        <div class="mt-4 pt-2 animated fadeInUpBig animation-delay-11">
                                            <a href="javascript:void(0)" class="btn btn-primary mt-2"><i
                                                    class="uil uil-envelope"></i> شروع کنید </a>
                                        </div>
                                    </div>
                                </div><!--end col-->
                            </div><!--end row-->
                ...
                <div class="carousel-item" data-bs-interval="3000">
                    <div class="bg-home d-flex align-items-center"
                        style="background: url('images/coworking/bg02.jpg') center center;">
                        <div class="bg-overlay"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-12 text-center">
                                    <div class="title-heading mt-4">
                                        <h6 class="text-light para-dark animated fadeInDownBig animation-delay-1">فضای
                                            همکاری بهترین نوع کار در شهر برای موفقیت است</h6>
                                        <h1
                                            class="heading mb-3 text-white title-dark animated fadeInUpBig animation-delay-3">
                                            فضای اداری در ویتنام</h1>
                                        <p
                                        ...
                                        <div
                                            ...
                                            <form>
                                                <input type="email" id="email" name="email" class="rounded"
                                                    placeholder="E-mail">
                                                <button type="submit" class="btn btn-primary">فضای کتاب</button>
                                            </form><!--end form-->
                                        </div>
                                    </div>
                                </div><!--end col-->
                ...
                <div class="carousel-item" data-bs-interval="3000">
                    <div class="bg-home d-flex align-items-center"
                        style="background: url('images/coworking/bg03.jpg') center center;">
                        <div class="bg-overlay"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-12 text-center">
                                    <div class="title-heading mt-4">
                                        <h6 class="text-light para-dark animated fadeInDownBig animation-delay-1">فضای ما
                                            برای شما</h6>
                                        <h1
                                            class="heading mb-3 text-white title-dark animated fadeInUpBig animation-delay-3">
                                            یک روز دفتر خود را داشته باشید</h1>
                                        <p
                                            class="para-desc mx-auto text-light para-dark animated fadeInUpBig animation-delay-7">
                                            کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ
                                            v5 html تبدیل محور بهره مند شوید.</p>
                                        <div class="mt-4 pt-2 animated fadeInUpBig animation-delay-11">
                                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                                                class="btn btn-icon btn-pills btn-primary m-1 lightbox"><i
                                                    data-feather="video" class="icons"></i></a><span
                                                class="fw-bold text-uppercase small text-light title-dark align-middle ms-1">اکنون
                                                تماشا کنید </span>
                                        </div>
                                    </div>
                                </div><!--end col-->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <h5>بیش از 10000 نفر از کل مشتریان جهان به مشتری اعتماد دارند</h5>
                </div><!--end col-->
            </div><!--end row-->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title ms-lg-4">
                        <h4 class="title mb-4">درباره انجمن ما</h4>
                        <p class="text-muted">شروع به کار با <span class="text-primary fw-bold"> فضای لندریک </span> که می
                            تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند. متن
                            ساختگی متنی است که در صنعت نشر یا طراحان وب برای اشغال فضایی استفاده می شود که بعداً با محتوای
                            واقعی پر خواهد شد. این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متون ساختگی
                            از قرن شانزدهم مورد استفاده حروفچینی ها قرار گرفته اند.</p>
                        <a href="javascript:void(0)" class="btn btn-primary mt-3">اکنون اضافه شوید </a>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--enc container-->
            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <h4 class="title mb-4">راحتی شما اولویت ما است</h4>
                ...
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-lg-6 text-center">
                        <div class="card-body section-title p-md-5">
                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                                class="play-btn mt-0 border border-light text-center lightbox">
                                <i data-feather="play" class="fea icon-ex-md text-dark"></i>
                            </a>
                            <h4 class="title mb-4 mt-4">ما رویاپردازان و همکاران خلاق هستیم</h4>
                            <p class="text-muted mx-auto para-desc mb-0">کار با لنـدریــک را شروع کنید که می تواند همه
                ...
                <div class="col-md-3 col-12 mt-4 pt-2">
                    <div class="card pricing-rates best-plan rounded bg-light text-center border-0">
                        <div class="card-body py-5">
                            ...
                            <h6 class="title text-uppercase mb-4">اعضا </h6>
                            ...
                            <p class="text-muted">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد
                                آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                            <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm mt-4">خرید از راست چین </a>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-md-3 col-12 mt-4 pt-2">
                    <div class="card pricing-rates best-plan rounded shadow text-center border-0">
                        ...
                        <div class="card-body py-5">
                            ...
                            <h6 class="title text-uppercase mb-4">پشتیبانی </h6>
                            <div class="d-flex justify-content-center mb-4">
                                <span class="h4 mb-0 mt-2">هزار تومان </span>
                            ...
                            <p class="text-muted">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد
                                آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                            <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm mt-4">شروع کنید </a>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-md-3 col-12 mt-4 pt-2">
                    <div class="card pricing-rates best-plan rounded bg-light text-center border-0">
                        <div class="card-body py-5">
                            ...
                            <h6 class="title text-uppercase mb-4">اختصاصی </h6>
                            <div class="d-flex justify-content-center mb-4">
                                <span class="h4 mb-0 mt-2">هزار تومان </span>
                ...
                <div class="col-md-3 col-12 mt-4 pt-2">
                    <div class="card pricing-rates best-plan rounded bg-light text-center border-0">
                        <div class="card-body py-5">
                            ...
                            <h6 class="title text-uppercase mb-4">دفتر </h6>
                            <div class="d-flex justify-content-center mb-4">
                                <span class="h4 mb-0 mt-2">هزار تومان </span>
                            ...
                            <p class="text-muted">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد
                                آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                            <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm mt-4">الآن امتحانش کن</a>
                        </div>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
    ...
    <section class="section bg-light">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <h4 class="title mb-4">همکاران معتمد</h4>
                        <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span
                                class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی
                            ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                    </div>
        ...
        <div class="container mt-100 mt-60">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <h4 class="title mb-4">اخبار اخیر و رویدادها </h4>
                        <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span
                                class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی
                            ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-7">
                    <div class="section-title me-lg-4">
                        <h4 class="title title-dark text-light mb-4">ما برای تجارت ساخته شده ایم - امروز ما را کاوش کنید !
                        </h4>
                        <p class="text-light para-dark para-desc mb-0">شروع به کار با <span
                                class="text-success fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی
                            ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        <div class="mt-4 pt-2">
                            <a href="javascript:void(0)" class="btn btn-primary m-1">اکنون نصب کن</a>
                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                                class="btn btn-icon btn-pills btn-primary m-1 lightbox"><i data-feather="video"
                                    class="icons"></i></a><span
                                class="fw-bold text-uppercase small text-light title-dark align-middle ms-1">اکنون تماشا
                                کنید </span>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-lg-4 col-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="card rounded shadow border-0">
                        <div class="card-body">
                            <h5 class="text-center">عضو شوید</h5>
                            ...
                            <form>
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-12 mb-0">
                                        <div class="d-grid">
                                            <button class="btn btn-primary">اکنون شروع کنید</button>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end row-->
                            </form><!--end form-->
