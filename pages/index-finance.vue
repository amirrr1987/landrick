<template>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-heading">
                        ...
                        <h1 class="heading fw-bold mb-3">کم حال شما برا ساخت انواع سایت <span
                                class="text-primary text-decoration-underline typewrite" data-period="2000"
                                data-type='[ "آژانسی", "شرکتی", "استارت آپ", "فروشگاهی" ]'> <span class="wrap"></span>
                            </span> <br> رشد تا سطح بالا</h1>
                ...
                <div class="col-xl-2 col-lg-4 col-md-4">
                    <div
                        ...
                        <div class="card-body p-0 content">
                            <h5>استراتژی </h5>
                            <p class="para text-muted mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده خواهد شد خواهد
                                بود از در طرح آن.</p>
                        </div>
                    </div>
                </div><!--end col-->
                    ...
                    <div class="ms-lg-4">
                        <div class="section-title">
                            ...
                            <p class="text-muted para-desc">شروع به کار با <span class="text-primary fw-bold">لنـدریـک
                                ...
                                دارید فراهم کند. به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه
                                استفاده می شود باقی مانده است.</p>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        ...
                        <p class="text-muted mx-auto para-desc">شروع به کار با <span class="text-primary fw-bold">لنـدریـک
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 mt-2">
                    <div class="px-md-4 pt-4 text-center">
                        ...
                        <p class="text-muted mb-0">گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر
                            استفاده می کردند هنگام نوشتن ملودی به ترتیب.</p>
                        ...
                        <div class="px-md-4 pt-4 text-start">
                            <div class="d-flex">
                                ...
                                <div class="flex-1 ms-2">
                                    ...
                                    <p class="mb-0 text-muted">هنگامی که متن ساختگی نسبتاً واقع بینانه باشد ، به گونه ای
                                        سودمند خواهد بود که طرح بندی ایجاد شود</p>
                                </div>
                            </div>
    ...
    <section class="section bg-cta" data-jarallax='{"speed": 0.5}'
        style="background: url('images/finance/cta.jpg') center center;" id="cta">
