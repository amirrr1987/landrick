            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide d-flex align-items-center overflow-hidden">
                    <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;"
                        data-background="images/corporate/1.jpg">
                        <div class="bg-overlay"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="title-heading text-center">
                                        <h1 class="heading text-white title-dark mb-4">جهان را کشف کنید <br> این تجارت شماست
                                        </h1>
                                        <p class="para-desc mx-auto text-white-50">کمپین خود را راه اندازی کنید و از تخصص ما
                ...
                <div class="swiper-slide d-flex align-items-center overflow-hidden">
                    <div class="slide-inner slide-bg-image d-flex align-items-center" style="background: center center;"
                        data-background="images/corporate/2.jpg">
                        <div class="bg-overlay"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="title-heading text-center">
                                        <h1 class="heading text-white title-dark mb-4">با مارک ما آشنا شوید <br> خبرهای جدید
                                            داریم </h1>
                                        <p class="para-desc mx-auto text-white-50">کمپین خود را راه اندازی کنید و از تخصص ما
                                            در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-12">
                                <div
                                    ...
                                    <div class="card-body p-0 content">
                                        <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">بهترین مشاوره
                                                مالی</a></h5>
                                        <p class="text-muted">مشهورترین آن که گفته می شود منشأ گرفته است</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 mt-4 mt-md-0 pt-2 pt-md-0">
                                <div
                                    ...
                                    <div class="card-body p-0 content">
                                        <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">مارک مالی
                                                مجاز</a></h5>
                                        <p class="text-muted">مشهورترین آن که گفته می شود منشأ گرفته است</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                <div
                                    ...
                                    <div class="card-body p-0 content">
                                        <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">مشاوره
                                                جامع</a></h5>
                                        <p class="text-muted">مشهورترین آن که گفته می شود منشأ گرفته است</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                <div
                                    ...
                                    <div class="card-body p-0 content">
                                        <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">بهترین مزایای
                                                مالیاتی</a></h5>
                                        <p class="text-muted">مشهورترین آن که گفته می شود منشأ گرفته است</p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-7 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="section-title ms-lg-4">
                        <h4 class="title mb-4">ما بزرگترین هستیم <br> کارشناس بازرگانی </h4>
                        <p class="text-muted">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند
                            هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند. متن ساختگی
                            متنی است که در صنعت نشر یا طراحان وب برای اشغال فضایی استفاده می شود که بعداً با محتوای واقعی پر
                            خواهد شد. این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متون ساختگی از قرن
                            شانزدهم مورد استفاده حروفچینی ها قرار گرفته اند.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-2">
                    <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                        ...
                        <div class="flex-1">
                            <h4 class="title mb-0">بر اساس بوت استرپ 4</h4>
                        </div>
                    </div>
                </div><!--end col-->
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6 mt-4 pt-2">
                                            <div class="section-title text-md-start">
                                                ...
                                                <h4 class="title text-white title-dark mb-0">دیدار با تجربه <br> و اعضا تیم
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12 mt-4 pt-md-2">
                                            <div class="section-title text-md-start">
                                                <p class="text-white-50 para-desc">کار با لنـدریــک را شروع کنید که می تواند
                                                    همه چیزهایی را که برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز
                                                    دارید فراهم کند.</p>
                                                <a href="javascript:void(0)" class="text-white title-dark">ادامه مطلب <i
    ...
    <section class="section">
            ...
            <div class="row mt-lg-4 align-items-center">
                <div class="col-lg-5 col-md-12 text-center text-lg-start">
                    <div class="section-title mb-4 mb-lg-0 pb-2 pb-lg-0">
                        <h4 class="title mb-4">هزینه مشاوره ما</h4>
                        <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span
                                class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی
                            ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
        ...
        <div class="container mt-100 mt-60">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <h4 class="title mb-4">مشتریان ما گفتند</h4>
                        <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span
                                class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی
                            ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                    </div>
        ...
        <div class="container mt-100 mt-60">
            <div class="row align-items-center mb-4 pb-2">
                ...
                <div class="col-lg-6">
                    <div class="section-title text-center text-lg-start">
                        <p class="text-muted mb-0 mx-auto para-desc">شروع به کار با <span
                                class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی
                            ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                    </div>
                </div><!--end col-->
