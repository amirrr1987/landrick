            ...
            <form>
              <div class="mb-0">
                <input
                  ...
                  required=""
                  placeholder="مرکز کمک را جستجو کنید"
                />
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 text-center">
          <div class="section-title mb-4 pb-2">
            ...
            <h4 class="title my-4" data-aos="fade-up" data-aos-duration="1400">
              منابع ارتباطی
            </h4>
            <p
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div
            class="card categories text-center rounded border-0"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <div class="card-body">
              ...
              />
              <h5>
                <a href="javascript:void(0)" class="text-dark">چت آنلاین </a>
              </h5>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          ...
          >
            <div class="card-body">
              <img
                src="~/assets/images/icon/customer-service.svg"
                class="avatar avatar-small mb-3"
                alt=""
              />
              <h5>
                <a href="javascript:void(0)" class="text-dark">سوشیال </a>
              </h5>
              <p class="text-muted mb-0 mt-3">
                اگر توزیع حروف و کلمات تصادفی باشد ، خواننده حواس او را پرت نمی
                کند از ساختن
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          ...
          >
            <div class="card-body">
              <img
                src="~/assets/images/icon/writing.svg"
                class="avatar avatar-small mb-3"
                alt=""
              />
              <h5>
                <a href="javascript:void(0)" class="text-dark">تیکت ها</a>
              </h5>
              <p class="text-muted mb-0 mt-3">
                اگر توزیع حروف و کلمات تصادفی باشد ، خواننده حواس او را پرت نمی
                کند از ساختن
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          ...
          >
            <div class="card-body">
              ...
              />
              <h5>
                <a href="javascript:void(0)" class="text-dark">نقل و قل</a>
              </h5>
              <p class="text-muted mb-0 mt-3">
                اگر توزیع حروف و کلمات تصادفی باشد ، خواننده حواس او را پرت نمی
                کند از ساختن
                ...
                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                  <div class="section-title ms-md-4">
                    ...
                    <p
                      ...
                      data-aos-duration="1400"
                    >
                      سیستم های CRM با جمع آوری وب سایت مشتری ، ایمیل ، تلفن ،
                      داده های رسانه های اجتماعی و موارد دیگر ، در چندین منبع و
                      کانال شروع می شوند. همچنین ممکن است به طور خودکار سایر
                      اطلاعات ، مانند اخبار اخیر در مورد فعالیت شرکت را به خود
                      اختصاص دهد و می تواند اطلاعات شخصی مانند تنظیمات شخصی
                      مشتری در ارتباطات را ذخیره کند..
                    </p>
                    <div
                      class="mt-4"
                      data-aos="fade-up"
                    ...
                    >
                      <a
                        ...
                        class="text-primary p-1 px-2 shadow rounded me-3"
    ...
    <div class="container mt-100 mt-60">
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-5 col-12 mt-4 pt-2">
          <img
            src="~/assets/images/customer/customer.svg"
            data-aos="fade-up"
            data-aos-duration="1400"
            class="img-fluid"
            alt=""
