            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <span class="badge rounded-pill bg-success" data-aos="fade-up" data-aos-duration="1000">ویژگی ها
                        </span>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-community" role="tabpanel"
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <img src="~/assets/images/saas/classic04.png" data-aos="fade-up"
                                        data-aos-duration="1400" class="img-fluid mx-auto d-block shadow rounded" alt="">
                                </div><!--end col-->
                                    ...
                                    <div class="section-title ms-md-4">
                                        ...
                                        <div class="mt-4" data-aos="fade-up" data-aos-duration="1800">
                                            <a href="javascript:void(0)"
                                                class="text-primary p-1 px-2 shadow rounded me-3">ادامه مطلب <i
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <div class="section-title me-md-4">
                                        <h4 class="title mb-4" data-aos="fade-up" data-aos-duration="1000">پورتال سلف سرویس
                                        </h4>
                                        <p class="text-muted" data-aos="fade-up" data-aos-duration="1400">سیستم های CRM با
                                            جمع آوری وب سایت مشتری ، ایمیل ، تلفن ، داده های رسانه های اجتماعی و موارد دیگر
                                            ، در چندین منبع و کانال شروع می شوند. همچنین ممکن است به طور خودکار سایر اطلاعات
                                ...
                                <div class="col-md-6 order-1 order-md-2">
                                    <img src="~/assets/images/saas/classic02.png" data-aos="fade-up"
                                        data-aos-duration="1400" class="img-fluid mx-auto d-block shadow rounded" alt="">
                                </div><!--end col-->
                            </div> <!--end row-->
                        </div><!--end teb pane-->
                        ...
                        <div class="tab-pane fade" id="pills-teamwork" role="tabpanel" aria-labelledby="teamwork-tab">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <img src="~/assets/images/saas/classic03.png" data-aos="fade-up"
                                        data-aos-duration="1400" class="img-fluid mx-auto d-block shadow rounded" alt="">
                                </div><!--end col-->

                                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <div class="section-title ms-md-4">
                                        <h4 class="title mb-4" data-aos="fade-up" data-aos-duration="1000">کار تیمی مناسب
                                        </h4>
                                        <p class="text-muted" data-aos="fade-up" data-aos-duration="1400">سیستم های CRM با
                                            جمع آوری وب سایت مشتری ، ایمیل ، تلفن ، داده های رسانه های اجتماعی و موارد دیگر
                                            ، در چندین منبع و کانال شروع می شوند. همچنین ممکن است به طور خودکار سایر اطلاعات
        ...
        <div class="container mt-100 mt-60">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-5 col-12 mt-4 pt-2">
                    <img src="~/assets/images/customer/customer.svg" data-aos="fade-up" data-aos-duration="1400"
                        class="img-fluid" alt="">
                </div>
