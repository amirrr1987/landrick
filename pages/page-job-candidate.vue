      ...
      <div class="row">
          ...
          <div class="card job-profile shadow border-0">
            ...
            <div class="card-body">
              ...
              <ul class="list-unstyled">
                <li class="h6">
                  <i data-feather="mail" class="fea icon-sm text-warning me-3"></i><span class="text-muted">ایمیل :</span>
                  thomas@mail.com
                </li>
                <li class="h6">
                  <i data-feather="gift" class="fea icon-sm text-warning me-3"></i><span class="text-muted">تاریخ تولد
                    :</span> فروردین 1390
                </li>
                <li class="h6">
                  <i data-feather="home" class="fea icon-sm text-warning me-3"></i><span class="text-muted">آدرس : </span>
                  خیابان ریضایات
                </li>
                <li class="h6">
                  <i data-feather="map-pin" class="fea icon-sm text-warning me-3"></i><span class="text-muted">شهر
                    :</span> شاهین دژ
                </li>
                <li class="h6">
                  <i data-feather="globe" class="fea icon-sm text-warning me-3"></i><span class="text-muted">کشور :</span>
                  شاهین دژ
                </li>
                <li class="h6">
                  <i data-feather="server" class="fea icon-sm text-warning me-3"></i><span class="text-muted">کد پستی
                    :</span> 521452
                </li>
                <li class="h6">
                  <i data-feather="phone" class="fea icon-sm text-warning me-3"></i><span class="text-muted">موبایل :
                  </span> (+125) 1542-8452
                </li>
              ...
              <div class="d-grid">
                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#Contactme" class="btn btn-primary"><i
                    class="uil uil-envelope align-middle"></i> تماس با من</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-8 col-md-7 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
          <div class="ms-lg-4">
            <h4>درباره من :</h4>
            <p class="text-muted">
              بدیهی است که من توسعه وب دارم. توسعه وب با بیش از 3 سال تجربه.
              با تجربه تمام مراحل چرخه توسعه برای پروژه های وب پویا. در مقابل
              استفاده از "محتوا در اینجا ، محتوا در اینجا" ، باعث می شود که
              انگلیسی شبیه خواندن باشد.
            </p>
            <p class="text-muted mb-0">
              ساختارهای داده و الگوریتم ها قلب برنامه نویسی هستند. در ابتدا
              بسیاری از توسعه دهندگان اهمیت آن را نمی دانند اما هنگامی که کار
              خود را در توسعه نرم افزار آغاز می کنید ، متوجه می شوید که کد شما
              زمان زیادی را می گیرد یا فضای زیادی را صرف می کند.
            </p>
                ...
                <div class="d-flex">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-muted mt-2 mb-0">
                      ...
                      اپیسوم که امروزه استفاده می شود باقی مانده است. می توان
                      حدس زد که در طول زمان حروف خاصی به موقعیتهای مختلف متن
                      اضافه یا حذف شده اند.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="mt-4 pt-2">
              ...
              <a href="javascript:void(0)" class="btn btn-outline-primary"><i class="uil uil-print"></i> چاپ رزومه
              </a>
            </div>
          </div>
        </div>
