          ...
          <div class="page-next-level">
            ...
            <ul class="list-unstyled mt-4">
              <li class="list-inline-item h6 user text-muted me-2">
                <i class="mdi mdi-account"></i> کالوین لورس
              </li>
              <li class="list-inline-item h6 date text-muted">
                <i class="mdi mdi-calendar-check"></i> اردیبهشت 1400
              </li>
            </ul>
            <div class="page-next">
            ...
            <div class="card-body content">
              ...
              <blockquote class="blockquote mt-3 p-3">
                <p class="text-muted mb-0 fst-italic">
                  ...
                  آنها به نوعی دچار تغییر شده اند, با شوخ طبعی تزریق شده ، یا
            ...
            <div class="card-body">
              ...
              <div class="widget mb-4 pb-2">
                ...
                <ul class="list-unstyled mt-4 mb-0 blog-categories">
                  <li>
                    <a href="jvascript:void(0)">مالی </a>
                    <span class="float-end">13</span>
                  </li>
                  <li>
                    <a href="jvascript:void(0)">شرکتی </a>
                    <span class="float-end">90 </span>
                  </li>
                  <li>
                    <a href="jvascript:void(0)">وبلاگ </a>
                    <span class="float-end">18</span>
                  </li>
                  <li>
                    <a href="jvascript:void(0)">کسب و کار</a>
                    <span class="float-end">20</span>
                  </li>
                  <li>
                    <a href="jvascript:void(0)">سرمایه گذاری </a>
