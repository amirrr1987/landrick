<template>
        ...
        <div class="col-lg-7 col-md-6">
          <div class="title-heading">
            ...
            <h4 class="heading text-white mb-3 title-dark">
              بهترین عملیات اطلاعاتی را در <br />
              شرکت داریم
            </h4>
      ...
      <div class="row">
        ...
        <div class="col-lg-12 text-center col-md-4 mt-4 pt-2">
          <a href="javascript:void(0)" class="btn btn-primary"
            >نمایش بیشتر <i data-feather="arrow-left" class="fea icon-sm"></i
          ></a>
        </div>
        <!--end col-->
      </div>
  ...
  <section class="section pt-0">
    <div class="container">
      <div
        class="p-4 rounded shadow bg-primary bg-gradient position-relative"
        style="z-index: 1"
      >
        <div class="row">
            ...
            <div class="progress-box">
              ...
              >
                <div
                  ...
                  style="width: 84%"
                >
                  <div class="progress-value d-block text-light title-dark h6">
                    84%
                  </div>
                </div>
              </div>
      ...
      >
        <div class="col-md-3 col-6 mt-4 pt-2">
          <div class="counter-box text-center">
            ...
            />
            <h2 class="mb-0 mt-4">
              <span class="counter-value" data-target="97">3</span>%
            </h2>
        ...
        <div class="col-md-3 col-6 mt-4 pt-2">
          <div class="counter-box text-center">
            <img
              src="~/assets/images/illustrator/Asset192.svg"
              class="avatar avatar-small"
              alt=""
            />
            <h2 class="mb-0 mt-4">
              <span class="counter-value" data-target="2">0</span>هزار
            </h2>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 mt-4 pt-2">
          <div
            class="card features feature-clean work-process bg-transparent process-arrow border-0 text-center"
          >
        ...
        <div class="col-md-4 mt-md-5 pt-md-5 mt-4 pt-2">
          <div
            class="card features feature-clean work-process bg-transparent d-none-arrow border-0 text-center"
          >
            <div class="icons text-primary text-center mx-auto">
