      ...
      <div class="row mt-5 mt-sm-0 align-items-center">
        <div class="col-lg-6 col-md-6">
          <div class="title-heading me-lg-4">
            ...
            <div class="mt-4 pt-2">
              <a href="javascript:void(0)" class="btn btn-soft-primary m-1"
                >18 هزار تومان</a
              >
              <a
                href="#!"
                data-type="youtube"
                data-id="yba7hPeTSjk"
                class="btn btn-icon btn-pills btn-soft-primary m-1 lightbox"
        ...
        <div class="col-lg-6 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
          <div class="bg-white p-5 rounded-md">
            <img
              src="~/assets/images/book/book.png"
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <div class="bg-light p-5 rounded-md shadow me-lg-5">
            <img
              src="~/assets/images/book/about.png"
              class="img-fluid mx-auto d-block"
              alt=""
            />
          </div>
        ...
        <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
          <div class="section-title">
            ...
            <ul class="list-unstyled text-muted my-4">
              <li class="list-inline-item me-lg-5 me-4">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 mt-sm-0 pt-sm-0">
          <div class="d-flex features feature-clean">
            ...
            <div class="content ms-3">
              <h5 class="mb-1">
                <a href="javascript:void(0)" class="text-dark">بازگشت پول</a>
              </h5>
              <p class="text-muted mb-0">
                این مورد زمانی لازم است که ، برای متن هنوز در دسترس نیست.
              </p>
            ...
            <div class="col-lg-9">
              <div class="row">
                <div class="col-md-4 col-12 mt-4 pt-2">
                  <div
                    class="card pricing-rates business-rate text-center shadow bg-white border-0 rounded"
                  >
                    <div
                    ...
                    <div class="card-body">
                      ...
                      <p class="text-muted mb-0">
                        از یادگیری ماشین و پرداخت های جهانی گرفته تا مقیاس بندی
                        تیم خود ، همه موارد را کاوش کنید.
                      </p>
                      <div class="d-grid">
                ...
                <div class="col-md-4 col-12 mt-4 pt-2">
                  <div
                    class="card pricing-rates business-rate starter-plan text-center shadow border-0 rounded"
                  >
                    <div class="card-body">
      ...
      <div class="row justify-content-center">
        <div class="col-12">
          <div class="section-title text-center mb-4 pb-2">
            ...
            <p class="text-muted para-desc mx-auto mb-0">
              شروع به کار با <span class="text-primary"> لنـدریـک </span> که می
              تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به
              آن نیاز دارید فراهم کند.
            </p>
          </div>
        </div>
        <!--end col-->
        ...
        <div class="col-md-12 mt-4 pt-2">
          <div class="tiny-six-item">
            <div class="tiny-slide">
              <div
                class="card border-0 work-container work-grid position-relative d-block overflow-hidden mx-2"
              >
                <div class="card-body p-0">
                  <a
                    href="images/book/1.jpg"
                    class="lightbox d-inline-block"
                    title=""
                  >
                    <img
