        ...
        <div class="col-lg-10">
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <ul class="list-unstyled d-flex justify-content-between mt-4">
                <li class="list-inline-item user me-2">
                  <a href="javascript:void(0)" class="text-muted"
                    ><i class="uil uil-user text-dark"></i> کالوین لورس</a
                  >
                </li>
              ...
              <img
                src="~/assets/images/blog/bg1.jpg"
              ...
              <p class="text-muted">
                ...
                توزیع حروف و کلمات تصادفی باشد ، خواننده حواس او را پرت نمی کند
                از قضاوت بی طرف در مورد تأثیر بصری و خوانایی انواع حروف
