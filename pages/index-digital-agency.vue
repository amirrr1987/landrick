        ...
        <div class="col-lg-6 col-md-6">
          <div class="title-heading mt-4">
            <div class="alert alert-light alert-pills shadow" role="alert">
              ...
              <span class="content">
                ساخته شده برای
                <span class="text-primary">همه ی مشاغل </span> شما به لنـدریــک
                نیاز دارید..</span
              >
            </div>
            <h1 class="heading mb-3">
              <span class="text-primary">دیجیتال مارکتینگ </span> همراه با
              <br />
              سئوی سایت
            </h1>
            ...
            <div class="mt-4 pt-2">
              <a href="javascript:void(0)" class="btn btn-pills btn-primary m-1"
                >شروع کنید
              </a>
              <a
                href="#!"
              ...
              ><span class="fw-bold text-uppercase small align-middle ms-1"
                >اکنون تماشا کنید
              </span>
            </div>
          </div>
  ...
  <section class="section overflow-hidden">
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="card border-0 text-center features feature-clean rounded">
            <div class="icons text-primary text-center mx-auto">
              <h3><i class="uil uil-flip-v d-block rounded h3 mb-0"></i></h3>
            </div>

            <div class="card-body p-0 mt-4">
              <a href="javascript:void(0)" class="title h5 text-dark"
                >تجزیه و تحلیل پیشرفته</a
              >
              <p class="text-muted mt-3 mb-0">
                ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت
                دارد.
              </p>
              <div class="mt-2">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
          <div class="section-title">
            <h4 class="title mb-4">ما بهترین خدمات سئو را ارائه می دهیم</h4>
            <p class="text-muted">
              کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت
              صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.
            </p>
            <ul class="list-unstyled text-muted">
              ...
              <li class="mb-0">
                <span class="text-primary h5 me-2"
                  ><i class="uil uil-check-circle align-middle"></i></span
                >با استعداد ما و آژانس بازاریابی مجرب
              </li>
              <li class="mb-0">
                <span class="text-primary h5 me-2"
                  ><i class="uil uil-check-circle align-middle"></i></span
            ...
            <div class="mt-4 pt-2">
              <a href="javascript:void(0)" class="btn btn-primary m-1"
                >ادامه مطلب <i class="uil uil-angle-left-b"></i
              ></a>
              <a
                href="#!"
                data-type="youtube"
    ...
    <div class="container mt-100 mt-60">
      <div class="row align-items-center">
        <div class="col-md-5">
          <ul
            class="nav nav-pills nav-justified flex-column rounded"
            id="pills-tab"
            role="tablist"
          >
            <li class="nav-item">
              ...
              >
                <div class="p-3 text-start">
                  <h5>ابزارهای مدیریتی</h5>
                  <p class="text-muted tab-para mb-0">
                    متن ساختگی متنی است که در انتشارات استفاده می شود صنعت یا
                    توسط طراحی وب برای اشغال فضا است که بعداً با محتوای "واقعی"
                    پر خواهد شد.
                  </p>
                </div> </a
              ><!--end nav link-->
            ...
            <li class="nav-item">
              <a
                class="nav-link border-top rounded"
                id="pills-smart-tab"
                data-bs-toggle="pill"
                href="#pills-smart"
                role="tab"
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2">
          <div class="section-title">
            <h4 class="title mb-4">
              سئوی سایت شما<br />
              با کمک لندریک بالاست
            </h4>
            <p class="text-muted">
              به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح بندی,
              غیرقابل خواندن از اهمیت زیادی برخوردار است: ادراک انسان برای
              شناسایی الگوها و تکرارهای خاص در متن تنظیم شده است. اگر توزیع حروف
              تأثیر بصری داشته باشد.
            </p>
            <a href="javascript:void(0)" class="btn btn-primary"
              >مطالب بیشتر <i data-feather="arrow-left" class="fea icon-sm"></i
            ></a>
          </div>
        </div>
        <!--end col--->
          ...
          <div class="tiny-single-item">
            <div class="tiny-slide">
              <div class="client-testi text-center">
                <p class="h5 text-muted fst-italic fw-normal">
                  " مشهورترین متن ساختگی "لورم ایپسوم " است که گفته می شود از
                  قرن 16 پدید آمده است. لورم ایپسوم در یک زبان شبه لاتین ساخته
                  شده است که کم و بیش با لاتین "مناسب" مطابقت دارد. این شامل یک
                  سری کلمات واقعی لاتین است. "
                </p>
      ...
      <div class="row justify-content-center">
        <div class="col-12">
          <div class="section-title mb-4 pb-2 text-center">
            <h4 class="title mb-4">برنامه های قیمت گذاری ما</h4>
      ...
      <div class="row justify-content-center">
        <div class="col-12 mt-4 pt-2">
          <div class="text-center">
            <ul
              class="nav nav-pills rounded-pill justify-content-center d-inline-block border"
              id="pills-tab"
              role="tablist"
            >
              <li class="nav-item d-inline-block">
                <a
                  class="nav-link px-3 py-2 rounded-pill active monthly"
                  id="Monthly"
                  data-bs-toggle="pill"
                  href="#Month"
                  role="tab"
              ...
              <li class="nav-item d-inline-block">
                <a
                  class="nav-link px-3 py-2 rounded-pill yearly"
                  id="Yearly"
                  data-bs-toggle="pill"
                  href="#Year"
                  role="tab"
      ...
      <div class="row">
        <div class="col-md-6 col-12 mt-4 pt-2">
          <div class="d-flex">
            ...
            <div class="flex-1">
              <h5 class="mt-0">
                آیا این <span class="text-primary">لنـدریـک </span> نسخه جدید
                است؟
              </h5>
              <p class="answer text-muted mb-0">
                به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح
                بندی, غیرقابل خواندن از اهمیت زیادی برخوردار است: ادراک انسان
                برای شناسایی الگوها و تکرارهای خاص در متن تنظیم شده است.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-12 mt-4 pt-2">
          <div class="d-flex">
            ...
            <div class="flex-1">
              ...
              <p class="answer text-muted mb-0">
                اگر توزیع حروف و کلمات تصادفی باشد ، خواننده حواس او را پرت نمی
                کند از قضاوت بی طرف در مورد تأثیر بصری
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-12 mt-4 pt-2">
          <div class="d-flex">
            ...
            <div class="flex-1">
              ...
              <p class="answer text-muted mb-0">
                بعلاوه ، هنگامی که متن ساختگی نسبتاً واقعی بینانه باشد ، به گونه
                ای سودمند خواهد بود که طرح ایجاد شده از انتشار نهایی به خطر
                نیفتد.
              </p>
            </div>
          </div>
        ...
        <div class="col-md-6 col-12 mt-4 pt-2">
          <div class="d-flex">
            ...
            <div class="flex-1">
              <h5 class="mt-0">
                این <span class="text-primary">لنـدریـک </span> با حساب من
                استفاده ایمن تر است؟
              </h5>
              <p class="answer text-muted mb-0">
                به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که
                امروزه استفاده می شود باقی مانده است. لورم اپیسوم ساخته شده است
                به زبان شبه لاتین که کم و بیش با 'مناسب' لاتین مطابقت دارد.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 text-center">
          <div class="section-title">
            ...
            <a href="page-contact-two.html" class="btn btn-primary mt-4"
              ><i class="uil uil-phone"></i> تماس با ما</a
            >
          </div>
        </div>
        <!--end col-->
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-5 col-md-5 col-12 order-1 order-md-2">
          <img
            src="~/assets/images/illustrator/user_interface.svg"
            class="img-fluid mx-auto d-block"
            alt=""
          />
        </div>
        ...
        >
          <div class="section-title">
            ...
            <div class="my-4">
              <a href="javascript:void(0)" class="btn btn-lg btn-dark mt-2 me-2"
                ><i class="uil uil-apple"></i> اپ استور</a
              >
              <a href="javascript:void(0)" class="btn btn-lg btn-dark mt-2"
                ><i class="uil uil-google-play"></i> پلی استور</a
              >
            </div>
            ...
            <div class="d-inline-block">
              <div class="pt-4 d-flex align-items-center border-top">
                <i
                  ...
                  class="fea icon-md me-2 text-primary"
                ></i>
                <div class="content">
                  <h6 class="mb-0">
                    اکنون برنامه را روی تلفن های همراه خود نصب کنید
                  </h6>
                  <a href="javascript:void(0)" class="text-primary"
