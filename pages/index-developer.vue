          ...
          >
            ...
            <div class="card-body p-0 mt-4">
              ...
              <p class="text-muted mt-2">
                ساخته شده به زبان شبه لاتین که کم و بیش مطابقت دارد.
              </p>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                >
                  <li class="nav-item">
                    <a
                      class="nav-link nav-link-alt rounded active"
                      id="pills-npm-tab"
                      data-bs-toggle="pill"
                      href="#pills-npm"
                      role="tab"
                      aria-controls="pills-npm"
                      aria-selected="false"
                    >
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link nav-link-alt rounded"
                      id="pills-nuget-tab"
                      data-bs-toggle="pill"
                      href="#pills-nuget"
                      role="tab"
                      aria-controls="pills-nuget"
                      aria-selected="false"
                    >
                      <div class="text-center">
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  >
                    <p class="text-muted fw-bold mb-0">
                      <span class="text-success">هزار تومان </span> npm نصب
        ...
        <div class="col-lg-4 col-md-6 mt-4 pt-2">
          ...
          >
            <div class="card-body p-0">
              ...
              <p class="text-muted">
                تمام اصول اولیه برای مشاغل تازه شروع شده.
              </p>
        ...
        <div class="col-lg-4 col-md-6 mt-4 pt-2">
          ...
          >
            ...
            <div class="card-body p-0">
              ...
              <p class="text-muted">
                برای مشاغل در حال رشد که مشتری بیشتری می خواهند بهتر است.
              </p>
        ...
        <div class="col-lg-4 col-md-6 mt-4 pt-2">
          ...
          >
            <div class="card-body p-0">
              ...
              <p class="text-muted">
                ویژگی های پیشرفته برای افراد حرفه ای که نیاز به سفارشی سازی
                بیشتری دارند.
              </p>
      ...
      <div class="row justify-content-center">
        <div class="col-12 text-center">
          <div class="section-title">
            <h4 class="title mb-4">
              آیا می خواهید در میان اولین کسی باشید که می فهمد؟
            </h4>
