          ...
          <div class="col-lg-7 col-md-7">
            <div class="title-heading me-lg-4">
              <h1 class="heading mb-3">
                خلاقیت ما شما است
                <span class="text-primary">موفقیت اتفاقی نیست</span>
              </h1>
              ...
              <div class="mt-4">
                <NuxtLink
                  ...
                  ><i class="uil uil-envelope"></i> شروع کنید
                </NuxtLink>
                <NuxtLink
                  to="/documentation"
                  class="btn btn-outline-primary mt-2"
                  ><i class="uil uil-book-alt"></i> اسناد
                </NuxtLink>
              </div>
            </div>
          </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 col-md-6 mt-4 pt-2">
            <div class="section-title ms-lg-5">
              ...
              <p class="text-muted">
                شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب
                کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و از آن در وب
                سایت استفاده کنید.
              </p>
        ...
        <div class="row align-items-center">
          ...
          >
            <div class="section-title">
              ...
              <p class="text-muted">
                استفاده از لندریک برای ساخت سایت شما به معنای هرگز نگرانی در
                مورد طراحی صفحه دیگر یا سازگاری با مرورگر نیست. کتابخانه سازنده
                و اجزای سازنده و طرح های از پیش طراحی شده ما ، زندگی شما را آسان
                تر می کند.
              </p>
              <ul class="list-unstyled text-muted">
                <li class="mb-0">
          ...
          <div class="col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
            <div class="d-flex">
              ...
              <div class="flex-1">
                ...
                <p class="answer text-muted mb-0">
                  اگر توزیع حروف و کلمات تصادفی باشد ، خواننده حواس او را پرت
                  نمی کند از قضاوت بی طرف در مورد تأثیر بصری
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-12 mt-4 pt-2">
            <div class="d-flex">
              ...
              <div class="flex-1">
                ...
                <p class="answer text-muted mb-0">
                  بعلاوه ، هنگامی که متن ساختگی نسبتاً واقعی بینانه باشد ، به
                  گونه ای سودمند خواهد بود که طرح ایجاد شده از انتشار نهایی به
                  خطر نیفتد.
                </p>
              </div>
            </div>
            ...
            <div class="d-flex">
              ...
              <div class="flex-1">
                ...
                <p class="answer text-muted mb-0">
                  ...
                  که امروزه استفاده می شود باقی مانده است. لورم اپیسوم ساخته شده
                  است به زبان شبه لاتین که کم و بیش با 'مناسب' لاتین مطابقت
                  دارد.
                </p>
              </div>
            </div>
