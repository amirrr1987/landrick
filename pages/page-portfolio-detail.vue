                ...
                <div class="col-lg-12 text-center">
                    <div class="page-next-level">
                        ...
                        <ul class="list-unstyled mt-4">
                            <li class="list-inline-item h6 user text-muted me-2"> <span class="text-dark">مشتری: </span>
                                کالوین لورس</li>
                            <li class="list-inline-item h6 date text-muted"> <span class="text-dark">تاریخ :</span> اردیبهشت
                                1400</li>
                        </ul>
                        <div class="page-next">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-10 mt-4 pt-2">
                    <div class="bg-light rounded p-4">
                        <p class="text-muted fst-italic mb-0">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم
                            اپیسوم که امروزه استفاده می شود باقی مانده است - لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                            ...
                            موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای
                    ...
                    <div class="bg-light rounded p-4 mt-4 pt-2">
                        <p class="text-muted fst-italic mb-0">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم
                            اپیسوم که امروزه استفاده می شود باقی مانده است صرفاً برای پر کردن یک فضا. این گزینه ها برای متن
                            های کلاسیک لورم اپیسوم اغلب سرگرم کننده هستند و داستان های کوتاه ، خنده دار یا مزخرفی را روایت
                            می کنند. "</p>
