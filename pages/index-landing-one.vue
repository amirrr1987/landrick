            ...
            <div class="row position-relative" style="z-index: 1;">
                    ...
                    <div class="title-heading">
                        ...
                        <div class="mt-4 pt-2">
                            ...
                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                                ...
                                class="fw-bold text-uppercase text-white-50 small align-middle ms-2">اکنون تماشا کنید
                            </span>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-md-5 col-12 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="shape-before">
                        <div class="carousel-cell"><img src="~/assets/images/landing/2.jpg" class="img-fluid rounded-md" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title text-center text-lg-start">
                        <h4 class="title mb-4">مشتری مطمئن توسط جعفر <br> <span class="text-primary"> 10000+ </span> از جهان
                        </h4>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6 mt-4 pt-2">
                                            <div class="section-title text-md-start">
                                                ...
                                                <h4 class="title text-white mb-0 title-dark">همه چیز را کنترل کنید <br> در
                                                    یک مکان واحد</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12 mt-4 pt-md-2">
                                            <div class="section-title text-md-start">
                                                <p class="text-white-50 para-desc">شروع به کار با <span
                                                        class="text-light title-dark"> لنـدریـک </span> که می تواند هر آنچه
                                                    را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم
                                                    کند.</p>
                                                <a href="javascript:void(0)" class="text-light title-dark">ادامه مطلب <i
                                    ...
                                    <div class="tiny-slide">
                                        <div class="d-flex client-testi m-2">
                                            ...
                                            <div class="flex-1 content p-3 shadow rounded bg-white position-relative">
                                                ...
                                                <p class="text-muted mt-2">" به نظر می رسد که تنها تکه هایی از متن اصلی در
                                                    متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                                                <h6 class="text-primary">- توماس لوری <small class="text-muted">سئو</small>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="d-flex client-testi m-2">
                                            ...
                                            <div class="flex-1 content p-3 shadow rounded bg-white position-relative">
                                                ...
                                                <p class="text-muted mt-2">" به نظر می رسد که تنها تکه هایی از متن اصلی در
                                                    متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                                                <h6 class="text-primary">- باباکارما <small class="text-muted">مترجم
                                                    </small></h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="d-flex client-testi m-2">
                                            ...
                                            <div class="flex-1 content p-3 shadow rounded bg-white position-relative">
                                                ...
                                                <p class="text-muted mt-2">" به نظر می رسد که تنها تکه هایی از متن اصلی در
                                                    متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                                                <h6 class="text-primary">- چری استین <small class="text-muted">مدیر </small>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="d-flex client-testi m-2">
                                            ...
                                            <div class="flex-1 content p-3 shadow rounded bg-white position-relative">
                                                ...
                                                <p class="text-muted mt-2">" به نظر می رسد که تنها تکه هایی از متن اصلی در
                                                    متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                                                <h6 class="text-primary">- دین لوس <small class="text-muted">توسعه دهنده
                                                    </small></h6>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="tiny-slide">
                                    <div class="d-flex client-testi m-2">
                                        ...
                                        <div class="flex-1 content p-3 shadow rounded bg-white position-relative">
                                            ...
                                            <p class="text-muted mt-2">" به نظر می رسد که تنها تکه هایی از متن اصلی در
                                                متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                                            <h6 class="text-primary">- جیل شبی <small class="text-muted">طراح </small>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
