                ...
                <div class="col-12">
                    <div class="text-slider">
                        <ul class="list-inline mb-0 move-text">
                            <li class="list-inline-item px-2 mb-0"><b>EOG</b> $ 55.88 <span class="text-success">+$ 4.62
                                    ( +9.01% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>CHKP</b> $ 120.03 <span class="text-danger">-$
                                    14.07 ( -10.49% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>FANG</b> $ 63.58 <span class="text-success">+$
                                    5.17 ( +8.84% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>M</b> $ 14.75 <span class="text-success">+$ 1.05 (
                                    +7.66% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>PKI</b> $ 139.72 <span class="text-danger">-$
                                    11.41 ( -7.55% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>ABMD</b> $ 326.23 <span class="text-danger">-$
                                    21.61 ( -6.21% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>BITCOIN</b> $ 37,471.47 <span class="text-danger">+$
                                    492.60 ( +1.33% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>XRP</b> <span> $ 0.39</span><span class="text-muted">
                                    UNCH</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>LITECOIN</b> <span> $ 148.67</span><span
                                    class="text-danger">-$ 5.58 ( -3.62% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>BITCOIN CASH</b> <span> $ 427.37</span><span
                                    class="text-danger">-$ 15.98 ( -3.60% )</span></li>
                            <li class="list-inline-item px-2 mb-0"><b>ETHEREUM</b> $ 1,647.87 <span class="text-danger">+$
                                    14.51 ( +0.89% )</span></li>
                        </ul>
                    </div>
                </div><!--end col-->
                ...
                <ul class="navigation-menu nav-light">
                        ...
                        <ul class="submenu megamenu">
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li><a href="index-modern-business.html" class="sub-menu-item">کسب و کار مدرن </a>
                                    </li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li><a href="index-videocall.html" class="sub-menu-item">ویدئو کنفرانس <span
                                                class="badge bg-danger">جدید </span></a></li>
                                    <li><a href="index-it-solution-two.html" class="sub-menu-item">شرکتی اطلاعاتی دو
                                            <span class="badge bg-danger">جدید </span></a></li>
                                    ...
                                    <li><a href="index-task-management.html" class="sub-menu-item">مدیریت وظایف </a>
                                    </li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li><a href="index-online-learning.html" class="sub-menu-item">آموزش آنلاین </a>
                                    </li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li><a href="index-social-marketing.html" class="sub-menu-item">سوشیال مدیا </a>
                                    </li>
                                    <li><a href="index-digital-agency.html" class="sub-menu-item"> دیجیتال آژانسی </a>
                                    </li>
                    ...
                    <li class="has-submenu parent-parent-menu-item">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> مرکز پشتیبانی
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="helpcenter-support-request.html" class="sub-menu-item">پشتیبانی تماسی
                                        </a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> قالب ایمیل</a><span
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="email-password-reset.html" class="sub-menu-item">بازیابی رمز عبور</a>
                                    </li>
                            ...
                            <li class="has-submenu parent-menu-item"><a href="javascript:void(0)">مشاغل </a><span
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="page-job-candidate-list.html" class="sub-menu-item">لیست نامزدها </a>
                                    </li>
                            ...
                            <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> وبلاگ </a><span
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="page-blog-sidebar.html" class="sub-menu-item">وبلاگ با سایدبار </a>
                                    </li>
                                    ...
                                    <li><a href="page-blog-detail-two.html" class="sub-menu-item">جزئیات وبلاگ 2 </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> مطالعه موردی
                                </a><span class="submenu-arrow"></span>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> نمونه کار </a><span
                                    class="submenu-arrow"></span>
                                <ul class="submenu">
                                    <li><a href="page-portfolio-modern.html" class="sub-menu-item">نمونه کار مدرن </a>
                                    </li>
                                    <li><a href="page-portfolio-classic.html" class="sub-menu-item">نمونه کار کلاسیک
                                        </a></li>
                                    <li><a href="page-portfolio-grid.html" class="sub-menu-item">نمونه کار گرید </a>
                                    </li>
                                    <li><a href="page-portfolio-masonry.html" class="sub-menu-item">نمونه کار ساختمانی
                                        </a></li>
                            ...
                            <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> دیگر صفحات </a><span
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="auth-cover-re-password.html" class="sub-menu-item">بازیابی رمز عبور
                                            2</a></li>
                                    <li><a href="auth-re-password-three.html" class="sub-menu-item">بازیابی رمز عبور
                                            3</a></li>
                                </ul>
                            </li>
            ...
            <div class="row justify-content-center">
                <div class="col-12 mt-5 pt-md-5">
                    <div class="title-heading text-center">
                        <h4 class="heading text-white title-dark mb-4">در عرض چند دقیقه ارز دیجیتالی را بخرید و بفروشید
                        </h4>
                        ...
                        <div class="subcribe-form mt-4 pt-2">
                            <form>
                                <div class="mb-2">
                                    <input class="rounded-pill" placeholder="آدرس ایمیل / شماره تلفن">
                                    <button type="submit" class="btn btn-pills btn-primary">اکنون ثبت نام کنید</button>
                                </div>
                            </form><!--end form-->
    ...
    <section class="section">
            ...
            <div class="row justify-content-center">
                <div class="col-12 mt-4 pt-2">
                    ...
                    <div class="mt-4 pt-2 text-center">
                        <a href="javascript:void(0)" class="text-primary h6">نمایش بیشتر <i
        ...
        <div class="container mt-100 mt-60">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        <h4 class="title mb-4">تبادل <span class="text-primary">بهتر ، سریع تر و با هم</span></h4>
                        <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span
                                class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد
                            آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                    </div>
                    ...
                    <div class="card explore-feature border-0 shadow rounded text-center bg-white">
                        <div class="card-body">
                            ...
                            <div class="content mt-3">
                                <h4 class="mb-0"><span class="counter-value" data-target="858">30 </span>+ میلیون</h4>
                ...
                <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                    <div class="card explore-feature border-0 shadow rounded text-center bg-white">
                        <div class="card-body">
                            ...
                            <div class="content mt-3">
                                <h4 class="mb-0"><span class="counter-value" data-target="445">10</span>+ هزار</h4>
                ...
                <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                    <div class="card explore-feature border-0 shadow rounded text-center bg-white">
                        <div class="card-body">
                            ...
                            <div class="content mt-3">
                                <h4 class="mb-0"><span class="counter-value" data-target="1154">11</span>+ هزار</h4>
                ...
                <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                    <div class="card explore-feature border-0 shadow rounded text-center bg-white">
                        <div class="card-body">
                            ...
                            <div class="content mt-3">
                                <h4 class="mb-0"><span class="counter-value" data-target="111">30</span> +</h4>
                        ...
                        <div class="accordion-item rounded shadow">
                            ...
                            <div id="collapseOne" class="accordion-collapse border-0 collapse show"
                                ...
                                <div class="accordion-body text-muted bg-white">
                                    تعداد زیادی از معابر لورم اپیسون در دسترس است ، اما اکثر آنها به نوعی دچار تغییر شده
                                    اند.
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 mt-4 pt-2">
                    <div class="card features fea-primary rounded p-4 bg-light position-relative overflow-hidden border-0">
                        ...
                        <div class="card-body p-0 content mt-3">
                            <p class="para text-muted mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده در طرح خود
                                از یک صفحه خوان خواهد بود.</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="javascript:void(0)" class="btn btn-outline-primary m-1"><i class="uil uil-android"></i>
                            آندروید اپ </a>
                        <a href="javascript:void(0)" class="btn btn-outline-primary m-1"><i class="uil uil-apple"></i>
                            اپ استور</a>
                ...
                <div class="col-lg-4 mt-4 pt-2">
                    ...
                    <div class="mt-4 text-center">
                        <a href="javascript:void(0)" class="text-primary h6">مستندات رسمی لنـدریــک</a>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
                        ...
                        <div class="section-title">
                            <div class="d-flex">
                                ...
                                <div class="flex-1 ms-md-4 ms-3">
                                    ...
                                    <p class="text-white-50 mb-0">ثبت نام کنید و آخرین نکات را از طریق ایمیل دریافت
                                        کنید.</p>
                                </div>
                            </div>
                        </div>
