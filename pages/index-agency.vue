<template>
        ...
        <div class="col-lg-7 col-md-7 order-1 order-md-2">
          <div class="title-heading mt-4 ms-lg-5">
            <h1 class="heading mb-3">
              ما استارت آپ خلاق هستیم
              <span class="text-primary"> لنـدریـک </span> یک قالب جذابیه!
            </h1>
    ...
    <div class="container mt-100 mt-60">
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-6">
          <img src="~/assets/images/saas/2.png" class="img-fluid" alt="" />
        </div>
        <!--end col-->

        <div class="col-lg-6 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
          <div class="section-title ms-lg-3">
            <h4 class="title mb-4">تجزیه و تحلیل محصول عالی با مشکل واقعی</h4>
            <p class="text-muted">
  ...
  <section
    ...
    style="background: url(`${~/assets/images/1.jpg}`) center center"
  >
        ...
        <div class="col-12 text-center">
          <div class="section-title">
            <h4 class="title title-dark text-white mb-4">
              دست از گذاشتن پول روی میز بردارید.
            </h4>
      ...
      <div class="row justify-content-center">
        <div class="col-12 text-center">
          <div class="section-title mb-4 pb-2">
            <h4 class="title mb-4">الگو کلمات کلیدی</h4>
