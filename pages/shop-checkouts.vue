            ...
            <form class="mt-4">
              <div class="row">
                ...
                <div class="col-12">
                  <div class="mb-3">
                    <label class="form-label"
                      >نام شرکت <span class="text-muted">(اختیاری)</span></label
                    >
                    <input
                      name="name"
                      id="companyname"
                ...
                <div class="col-12">
                  <div class="mb-3">
                    <label class="form-label"
                      >آدرس خیابان <span class="text-danger">*</span></label
                    >
                    <input
                      type="text"
                      name="address1"
                ...
                <div class="col-12">
                  <div class="mb-3">
                    <label class="form-label"
                      >آپارتمان، واحد 44.
                      <span class="text-muted">(اختیاری)</span></label
                    >
                    <input
                      type="text"
                      name="address2"
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    <label class="form-label"
                      >شهر / منطقه <span class="text-danger">*</span></label
                    >
                    <input
                      type="text"
                      name="city"
                ...
                <div class="col-12">
                  <div class="mb-3">
                    <label class="form-label"
                      >تلفن <span class="text-danger">*</span></label
                    >
                    <input
                      type="text"
                      name="phone"
            ...
            <div class="mb-0">
              <div class="form-check">
                <input
                  ...
                  id="creataccount"
                />
                <label class="form-check-label" for="creataccount"
                  >ایجاد حساب کاربری؟</label
                >
              </div>
            </div>
          </div>
          ...
          <div class="rounded shadow-lg p-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                class="form-control"
                placeholder="یادداشت هایی در مورد سفارش شما :"
              ></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-5 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
          <div class="rounded shadow-lg p-4 sticky-bar">
            ...
            <div class="table-responsive">
                  ...
                  >
                    <div class="form-check mb-0">
                      <input
                        ...
                        id="chequepay"
                      />
                      <label class="form-check-label" for="chequepay"
                        >پرداخت را چک کنید</label
                      >
                    </div>
                  </div>
                </li>
              ...
              <div class="mt-4 pt-2">
                <div class="d-grid">
                  <a href="shop-checkouts.html" class="btn btn-primary"
                    >سفارش دهید</a
                  >
                </div>
              </div>
