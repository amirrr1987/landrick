<template>
  ...
  <section
    ...
    style="
      background: url('images/integration/bg.png') center center;
      height: auto;
    "
    id="home"
  >
      ...
      <div class="row mt-5 justify-content-center">
        <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
          <div class="title-heading">
            ...
            <h4 class="heading text-white title-dark my-3">
              آینده نیز هست <br />
              <b>جالب هست</b> و بودن <b> قابل پیش بینی است</b>.
            </h4>
            <p class="para-desc mx-auto text-white-50">
              در مورد همه چیز ، از یادگیری ماشین و پرداخت های جهانی گرفته تا
              مقیاس بندی تیم خود ، مقاله را کاوش و ادامه دهید.
            </p>
          </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="row">
            <div class="col-md-6">
              <div
                class="d-flex features feature-clean core-feature rounded shadow p-4"
              >
                ...
                <div class="flex-1 ms-4">
                  ...
                  <p class="text-muted mt-2 mb-0">
                    ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین
                    مطابقت دارد.
                  </p>
                </div>
              </div>
    ...
    <div class="container mt-100 mt-60">
      <div class="row align-items-center">
        <div class="col-lg-5 col-md-6">
          <img
            src="~/assets/images/integration/interactiondesign-amico.svg"
            class="img-fluid"
            alt=""
          />
        </div>
        ...
        <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
          <div class="section-title ms-lg-5">
            ...
            <h5>
              <i class="uil uil-arrow-circle-right text-primary me-1"></i> نظارت
              بر ادغام ابزار
            </h5>
            <p class="text-muted para-desc ms-4 ps-2">
              صفحه وضعیت را با دیتاداگ ، یادگار جدید ، لایبرتو یا پینگدوم تلفیق
              کنید تا صفحه شما به محض شناسایی مسئله به روز شود.
            </p>
            <h5>
              <i class="uil uil-arrow-circle-right text-primary me-1"></i> هشدار
              یکپارچه سازی ابزار
            </h5>
            <p class="text-muted para-desc ms-4 ps-2">
              برای بروزرسانی مستقیم وضعیت از برنامه هشدار دهنده ، وضعیت وضعیت را
              با Opsgenie ، PagerDuty ، VictorOps یا مترس تلفیق کنید.
            </p>
            <h5>
            ...
            <p class="text-muted para-desc ms-4 ps-2">
              از REST API ما برای به روزرسانی برنامه ای صفحه وضعیت خود با نوشتن
              یکپارچه سازی خود استفاده کنید ، یا به طور خودکار وضعیت اجزای
              سازنده را با ایجاد ایمیل با یک عنوان عنوان حاوی کلمات "UP" یا
              "DOWN" به روز کنید..
            </p>
          </div>
        </div>
    ...
    <div class="container mt-100 mt-60">
      <div class="row align-items-center">
        <div class="col-lg-5 col-md-6 order-1 order-md-2">
          <img
            src="~/assets/images/integration/1.png"
            class="img-fluid"
            alt=""
          />
        </div>
        ...
        >
          <div class="section-title me-lg-5">
            <h4 class="title mb-4">
              وب سایت های خود را تحویل دهید <br />
              سریع تر ، و بهتر.
            </h4>
            <p class="text-muted">
            ...
            <div class="mt-4">
              <a href="javascript:void(0)" class="btn btn-primary"
                >ادامه مطلب <i data-feather="arrow-left" class="fea icon-sm"></i
              ></a>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-7">
            <div class="section-title">
              <div class="d-flex">
                <i
                  class="uil uil-mobile-android display-4 text-white title-dark"
                ></i>
                <div class="flex-1 ms-md-4 ms-3">
                  ...
                  <p class="text-white-50 mb-0">
                    با استفاده از لندریک وب سایت هایی با ظاهری مدرن را سریع و
                    آسان بسازید.
                  </p>
                </div>
              </div>
          ...
          <div class="col-md-5 mt-4 mt-sm-0">
            <div class="text-md-end ms-5 ms-sm-0">
              <a
                ...
                class="btn btn-primary me-2 me-lg-2 me-md-0 my-2"
                ><i class="uil uil-apple"></i> اپ استور</a
              >
              <a href="javascript:void(0)" class="btn btn-soft-primary my-2"
