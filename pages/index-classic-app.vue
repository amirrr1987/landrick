                ...
                <div class="col-lg-7 col-md-7">
                    <div class="title-heading mt-4">
                        <div class="alert alert-transparent alert-pills shadow" role="alert">
                            ...
                            <span class="content">افزوده جدید برنامه ویترین مدرن و کلاسیک</span>
                        </div>
                        <h1 class="heading mb-3">ما بهترین برنامه هایی را ایجاد می کنیم که کاربران آنها را دوست دارند</h1>
    ...
    <section class="section overflow-hidden">
            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <span class="badge bg-primary rounded-pill mb-2">ویژگی ها </span>
                ...
                <div class="col-md-4 col-12 mt-4 pt-2">
                    <div class="card text-center rounded border-0">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)" class="text-dark">طراحی و مارک تجاری</a></h5>
                                <p class="text-muted mt-3 mb-0">اگر توزیع حروف و کلمات توزیع تصادفی باشد ، خواننده حواس او
                                    را پرت نمی کند.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-12 mt-4 pt-2">
                    <div class="card text-center bg-primary bg-gradient rounded border-0">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)" class="text-white title-dark">کاملاً امن</a></h5>
                                <p class="text-white-50 mt-3 mb-0">اگر توزیع حروف و کلمات توزیع تصادفی باشد ، خواننده حواس
                                    او را پرت نمی کند.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-12 mt-4 pt-2">
                    <div class="card text-center rounded border-0">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)" class="text-dark">عملکرد بالا</a></h5>
                                <p class="text-muted mt-3 mb-0">اگر توزیع حروف و کلمات توزیع تصادفی باشد ، خواننده حواس او
                                    را پرت نمی کند.</p>
                            </div>
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-7 mt-5 mt-sm-0">
                    <div class="section-title">
                        <h1 class="title mb-3">ما با عملکرد بالا کار می کنیم <br> در ساخت اپلیکیشن </h1>
                        <p class="para-desc text-muted">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت
                            صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
        ...
        <div class="container mt-100 mt-60">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-7 order-2 order-md-1 mt-5 mt-sm-0">
                    <div class="section-title">
                        <h1 class="title mb-3">آسان و بهترین راه حل <br> برای اپ سایت شما در دسترس است </h1>
                        <p class="para-desc text-muted">لورم اپیسوم درد شما را آغاز می کند ، تخفیف های هویج را افزایش می
                            دهد. اما ما می توانیم چمدان را همراه با پرهیز از حقیقتی که او می خواهد انتخاب کنیم. اما از روی
                            نفرت ، و از. چگونه انتخاب شده است ، لذت واقعیت این جهان برای هیچ چیز کمتر است. کمپین کنید و از
                            تخصص ما در زمینه طراحی و مدیریت بهره مند شوید صفحه بوت استرپ HTML V5 با محوریت تبدیل.</p>
                        <div class="mt-4">
                            <a href="javascript:void(0)" class="btn btn-primary">ادامه مطلب <i
                                    class="uil uil-angle-left-b"></i></a>
                        </div>
                    </div>
                </div><!--end col-->
        ...
        <div class="container mt-100 mt-60">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-7 mt-5 mt-sm-0">
                    <div class="section-title">
                        <h1 class="title mb-3">زیبا و آسان برای و <br> استفاده آسان</h1>
                        <p class="para-desc text-muted">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت
                            صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                        <ul class="list-unstyled text-muted">
                            <li class="mb-0"><span class="text-primary h5 me-2"><i
        ...
        <div class="container mt-100 mt-60 pb-md-5 mb-md-5">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        <span class="badge rounded-pill bg-success mb-2">نظرات </span>
                        <h4 class="title mb-4">آنچه کاربران ما می گویند!</h4>
                        <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold">
                                لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن
                            نیاز دارید فراهم کند.</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <div class="section-title text-center text-md-start">
                        <h1 class="title text-white title-dark mb-2">مشترک شدن در اخبار هفتگی ما</h1>
                        <p class="text-light para-dark">ثبت نام کنید و آخرین نکات را از طریق ایمیل دریافت کنید.</p>
                    </div>
